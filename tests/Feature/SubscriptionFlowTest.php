...
test('subscription stores next billing one minute ahead for minute plan', function () {
    Carbon::setTestNow('2026-02-13 10:00:00');

    $user = User::factory()->create();
    $plan = Plan::query()->where('frequency', 'minute')->firstOrFail();
    ...
    expect($subscription->next_billing_at->toDateTimeString())->toBe('2026-02-13 10:01:00');
});
